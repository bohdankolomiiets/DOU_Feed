...
import com.bogdan_kolomiets_1996.bogdan.dou_feed.ui.MainActivity;
...
public class FeedFragment extends BaseFragment implements FeedView, FeedAdapter.OnFeedListener {
    ...
    public void onStart() {
        super.onStart();
        ((MainActivity) getActivity()).setUpSearchViewVisibility(View.VISIBLE);
        ((MainActivity) getActivity()).setSearchViewListener(new MainActivity.OnSearchListener() {
            @Override
            public void onOpenClick(Toolbar toolbar) {
                ObjectAnimator objectAnimator = ObjectAnimator.ofObject(toolbar, "backgroundColor",
                        new ArgbEvaluator(),
                        ContextCompat.getColor(getContext(), R.color.black),
                        ContextCompat.getColor(getContext(), R.color.silver));
                objectAnimator.setDuration(100);
                objectAnimator.start();
            }

            @Override
            public void onCloseClick(Toolbar toolbar) {
                ObjectAnimator objectAnimator = ObjectAnimator.ofObject(toolbar, "backgroundColor",
                        new ArgbEvaluator(),
                        ContextCompat.getColor(getContext(), R.color.silver),
                        ContextCompat.getColor(getContext(), R.color.black));
    ...
    public void onStop() {
        super.onStop();
        ((MainActivity) getActivity()).setUpSearchViewVisibility(View.GONE);
    }
